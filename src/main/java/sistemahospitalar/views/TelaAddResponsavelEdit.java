 ...
 * @author caiod
 */
public class TelaAddResponsavelEdit extends javax.swing.JFrame {

    /**
     * Creates new form TelaAddResponsavel
     */
    Paciente paciente;
    public TelaAddResponsavelEdit(Paciente pac) {
        initComponents();
        paciente = pac;
    }

    private TelaAddResponsavelEdit() {
    ...
    private void jButtonVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVoltarActionPerformed
        ...
        EditarPaciente telaAnterior = new EditarPaciente(paciente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAddResponsavelEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAddResponsavelEdit().setVisible(true);
            }
        });
    }
