...
public class EditarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editando paciente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 18))); // NOI18N
        ...
        jLabel15.setText("Responsaveis (sem acento)");
    ...
    private void jButtonAddRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddRespActionPerformed
        // Cria uma instância 
        TelaAddResponsavelEdit telaAddResponsavel = new TelaAddResponsavelEdit(meuPaciente);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        novoPaciente.setIdPaciente(meuPaciente.getIdPaciente());
        novoPaciente.setResponsaveis(meuPaciente.getResponsaveis());
        novoPaciente.setHistoricoConsultasMedica(meuPaciente.getHistoricoConsultasMedica());
        
        // Adiciona o novo paciente ao grupo de pacientes
        try {
            GrupoPaciente.getGrupo().set(meuPaciente.getIdPaciente(), novoPaciente);
            // Exibe a mensagem de sucesso
            JOptionPane.showMessageDialog(null, "Paciente editado com sucesso!");
        } catch (Exception ex) {
            // Se ocorrer uma exceção, exibe uma mensagem de erro
            JOptionPane.showMessageDialog(null, "Erro ao ediçao o paciente: " + ex.getMessage());
        }
