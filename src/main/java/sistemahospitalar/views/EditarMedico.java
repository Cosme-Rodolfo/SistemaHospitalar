...
public class EditarMedico extends javax.swing.JFrame {
    ...
    Medico meuMedico;
    public EditarMedico(Medico med) {
        ...
        jTextFieldNome.setText(meuMedico.getNomeCompleto());
        jTextFieldDataNasc.setText(meuMedico.getDataNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));        
        if (meuMedico.getEndereco() != null){
            jTextFieldRua.setText(meuMedico.getEndereco().getRua());
            jTextFieldNum.setText(String.valueOf(meuMedico.getEndereco().getNumero()));
            jTextFieldBairro.setText(meuMedico.getEndereco().getBairro());
            jTextFieldCidade.setText(meuMedico.getEndereco().getCidade());
            jTextFieldEstado.setText(meuMedico.getEndereco().getEstado());
            jTextFieldCEP.setText(String.valueOf(meuMedico.getEndereco().getCep()));
        }
        if (meuMedico.getContato() != null){
            jTextFieldTel.setText(meuMedico.getContato().getTelefone());
            jTextFieldCel.setText(meuMedico.getContato().getCelular());
            jTextFieldEmail.setText(meuMedico.getContato().getEmail());
        }
        if (meuMedico.getGenero() == Genero.F) {
            jRadioButtonF.setSelected(true);
        } else if (meuMedico.getGenero() == Genero.M) {
            jRadioButtonM.setSelected(true);
        }
        
        if (!meuMedico.getAreasEspecialidade().isEmpty()){
            jTextFieldAreaEsp.setText(String.join(", ", meuMedico.getAreasEspecialidade()));
        }
        jTextFieldCRM.setText(String.valueOf(meuMedico.getNumeroCRM()));
        jTextFieldSetor.setText(meuMedico.getSetor());
        jTextFieldCargaH.setText(String.valueOf(meuMedico.getChSemanais()));
        jRadioButtonYCirurgiao.setSelected(meuMedico.isCirurgiao());
        jRadioButtonNCirurgiao.setSelected(!meuMedico.isCirurgiao());
    }

    private EditarMedico() {
    ...
    private void initComponents() {
        ...
        jRadioButtonYCirurgiao = new javax.swing.JRadioButton();
        jRadioButtonNCirurgiao = new javax.swing.JRadioButton();
        jLabel20 = new javax.swing.JLabel();
        jTextFieldAreaEsp = new javax.swing.JTextField();
        jLabel21 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editando medico", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 18))); // NOI18N
        ...
        jLabel18.setText("Cirurgiao:");

        jRadioButtonYCirurgiao.setText("yes");
        jRadioButtonYCirurgiao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButtonYCirurgiaoActionPerformed(evt);
            }
        });

        jRadioButtonNCirurgiao.setText("no");
        jRadioButtonNCirurgiao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButtonNCirurgiaoActionPerformed(evt);
            }
        });

        jLabel20.setText("Area de Especialidade:");

        jTextFieldAreaEsp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldAreaEspActionPerformed(evt);
            }
        });

        jLabel21.setFont(new java.awt.Font("SansSerif", 3, 14)); // NOI18N
        jLabel21.setText("Info. Medicas:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jRadioButtonYCirurgiao, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jRadioButtonNCirurgiao, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(213, 213, 213))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(jTextFieldAreaEsp, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGap(26, 26, 26)
                                        .addComponent(jLabel19, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTextFieldCRM, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextFieldAreaEsp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel18)
                    .addComponent(jRadioButtonYCirurgiao)
                    .addComponent(jRadioButtonNCirurgiao))
                .addGap(42, 42, 42)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if (jTextFieldNome.getText().isEmpty() || jTextFieldDataNasc.getText().isEmpty() || jTextFieldRua.getText().isEmpty() ||
            ...
            jTextFieldCel.getText().isEmpty() || jTextFieldEmail.getText().isEmpty() || jTextFieldCRM.getText().isEmpty() ||
            jTextFieldSetor.getText().isEmpty() || jTextFieldCargaH.getText().isEmpty() || jTextFieldAreaEsp.getText().isEmpty()) {
        ...
        int numeroCRM = Integer.parseInt(jTextFieldCRM.getText());
        boolean isCirurgiao = jRadioButtonYCirurgiao.isSelected();
        ...
        List<String> areasEspecialidade = Arrays.asList(jTextFieldAreaEsp.getText().split(","));
        ...
        Medico novoMedico = new Medico(nomeCompleto, dataNascimento, endereco, contato, genero, numeroCRM, areasEspecialidade, isCirurgiao, setor, chSemanais);
        novoMedico.setIdMedico(meuMedico.getIdMedico());
        
        // Adiciona o novo médico ao grupo de médicos
        try {
            GrupoMedico.getGrupo().set(meuMedico.getIdMedico(), novoMedico);
    ...
    private void jButtonVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVoltarActionPerformed
        ...
        TelaListagemMed telaAnterior = new TelaListagemMed();
    ...
    private void jRadioButtonYCirurgiaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonYCirurgiaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jRadioButtonYCirurgiaoActionPerformed

    private void jRadioButtonNCirurgiaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonNCirurgiaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jRadioButtonNCirurgiaoActionPerformed

    private void jTextFieldAreaEspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldAreaEspActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldAreaEspActionPerformed
    ...
    private javax.swing.JRadioButton jRadioButtonNCirurgiao;
    private javax.swing.JRadioButton jRadioButtonYCirurgiao;
    private javax.swing.JTextField jTextFieldAreaEsp;
